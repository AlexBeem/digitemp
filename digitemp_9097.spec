...
It requires a serial port and a DS9097U-9 adapter. It includes perl scripts
...
This RPM package has been compiled for the DS9097 passive 1-wire adapter.
%prep
%setup
...
install -s -g lock -m 2755 digitemp_DS9097 $RPM_BUILD_ROOT/usr/local/bin/
